...
function Calendar({
  ...
  onMonthChange, // forwarded from parent
  ...props
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn(
          "text-white rounded-md flex-1 font-bold text-[0.8rem] select-none",
        ...
        today: cn(
          "bg-primary text-accent-foreground rounded-lg data-[selected=true]:rounded-none",
