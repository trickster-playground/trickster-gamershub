...
export const heroData = {
  sectionSubtitle: 'Esports events. Community. Competition.',
  sectionTitle: 'The next-gen of esports platform',
  decoTitle: 'GamersHub',
  sectionText:
    'Discover and join tournaments, explore gaming communities, and create events with a complete bracket management system — all in one hub.',
};
